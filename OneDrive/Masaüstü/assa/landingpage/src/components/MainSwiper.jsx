...
import layer1 from '/src/assets/layer.svg'
import computersvg from '/src/assets/computer.svg'
import {Swiper, SwiperSlide} from "swiper/react";
import recomended1 from "/src/assets/recomended1.png"
import recomended2 from "/src/assets/recomended2.png"
import recomended3 from "/src/assets/recomended3.png"
            ...
            <div className={'flex flex-col items-center'}>
                <div
                    ...
                    <div className={'flex flex-col h-full  items-center'}>
                        <div className={'flex gap-[30px] lg:gap-[85px] h-full items-center flex-row'}>
                            <div onClick={() => {
                                handlePrev(sliderRef3)
                            }} className={'h-full lg:px-[58px] py-[250px] cursor-pointer'}>
                                <svg onClick={() => {
                                    handlePrev(sliderRef3)
                            ...
                            <div className={'md:w-[600px] lg:w-[1000px] h-full'}>
                                <Swiper
                                    ref={sliderRef3}
                                    className={'w-[100%] flex flex-row h-full cursor-pointer'}
                                    spaceBetween={100}
                                    slidesPerView={1}
                                ...
                                >
                                    ...
                                    <SwiperSlide>
                                        <div className={'w-full mr-[20px] flex items-center justify-center'}>
                                            <img className={'w-[431px]  h-[323px]  select-none '} src={computersvg}
                                                 alt=""/>
                                            <div className={'flex flex-col mt-[83px] pr-[53px]'}>
                                                <div className={''} style={{
                                                    ...
                                                    <h3 className={'font-bold items-center flex justify-center flex-col items-center text-[48px]'}>
                                                        Easy-to-use
                                ...
                                Recruitment Software
                                                ...
                                                <h5 className={'mt-[2px] text-[#383838] font-normal text-[20px] w-[540px]'}>
                                                ...
                                                <div
                                                    ...
                                                    <h5 className={'font-normal text-[20px] w-[487px]'}>
                            ...
                            <div
                                ...
                                className={'h-full px-[30px] lg:px-[58px] py-[250px] cursor-pointer'}>
                                <svg onClick={() => {
                                    handleNext(sliderRef3)
                                }} className={'cursor-pointer select-none'} width="13" height="24" viewBox="0 0 13 24"
                                     fill="none"
                ...
                <div className={'mt-[47px] select-none cursor-pointer w-[421px] text-white flex justify-center items-center font-medium shadowl3 h-[49px] bg-[#E30019] bg-opacity-60 rounded-[30px]'}>
                    Try it for free for 14 days
                </div>
            </div>
            <div className={'flex flex-col absolute left-0 top-20 -z-10  gap-0 w-full'}>
                ...
                <svg className={'w-full h-auto object-cover'} width="1448" height="230" viewBox="0 0 1448 230"
                     fill="none" xmlns="http://www.w3.org/2000/svg">
