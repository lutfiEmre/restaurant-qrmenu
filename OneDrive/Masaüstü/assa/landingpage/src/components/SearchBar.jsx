                ...
                <div className={'flex flex-col justify-center sm:flex-row gap-6 w-full items-center  h-full'}>
                    ...
                    <div className={'flex items-center flex-row w-fit lg:mr-[100px] -ml-1 '}>
                        ...
                        <input placeholder={'Search Jobs or Company'}
                               className={'outline-none w-fit sm:w-[250px] pl-10 bg-transparent font-thin placeholder:text-[#E30019] text-[16px] md:text-[14px]'}
                               type="text"/>
                    </div>
                    ...
                    <div className={'flex flex-row items-center sm:mr-6 w-fit '}>
                        ...
                        <input placeholder={'City / Country'}
                               className={'outline-none w-fit sm:w-[150px] md:w-[250px] pl-8 bg-transparent font-thin placeholder:text-[#E30019] text-[16px] md:text-[14px]'}
                               type="text"/>
                    </div>
                </div>
                <div
