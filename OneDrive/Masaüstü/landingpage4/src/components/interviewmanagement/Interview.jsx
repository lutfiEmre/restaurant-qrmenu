...
import mansvg from '../../assets/interviewmanagement/man1.svg'
import people1svg from '../../assets/interviewmanagement/people1.svg'
import people2svg from '../../assets/interviewmanagement/people2.svg'
import people3svg from '../../assets/interviewmanagement/people3.svg'
import people4svg from '../../assets/interviewmanagement/people4.svg'
import classic from '../../assets/interviewmanagement/clasic.png'
...
function Interview() {
    ...
    <div className="w-full h-full min-h-screen relative  bg-[#F4F4F4]  flex flex-row">
        ...
        <div className={'w-full h-full z-20 pl-[30px]  md:pl-[30px] pr-[25px] md:pr-[40px] pt-[47px] pb-[175px]'}>
            <div className={'w-full h-fit flex  flex-row justify-between items-center'}>
                <div className={'flex !bg-transparent items-center  select-none cursor-pointer flex-row gap-2'}>
                    ...
                    <input placeholder={'Search'}
                           className={'md:w-[150px] border-none items-center  !bg-transparent w-[100px] lg:w-fit opacity-60 pl-8  nunitomedium placeholder:text-[#2B2F42] outline-none'}
                           type="text"/>
                </div>
            ...
            <div
                className={'sm:mt-[33px] mt-[50px] flex-wrap w-full justify-around justify-center flex items-center flex-row gap-8 2xl:gap-[65px]'}>
                <div className={'w-[311px] h-[196px] flex items-center flex-col justify-start  rounded-[32px] shadow1'}>
                    <div
                    ...
                    <div className={'pt-[26px] w-full flex items-center justify-between pl-[45px] pb-[27px] pr-[29px]'}>
                ...
                <div className={'w-[311px] h-[196px] flex items-center flex-col justify-start  rounded-[32px] shadow1'}>
                    ...
                    <div className={'pt-[26px] w-full flex gap-6 justify-center items-end  pb-[27px]'}>
                ...
                <div className={'w-[311px] h-[196px] flex items-center flex-col justify-start  rounded-[32px] shadow1'}>
                    ...
                    <div className={'pt-[26px] w-full flex gap-6 justify-between p-8 items-end  pb-[27px]'}>
                        <svg width="88" height="88" viewBox="0 0 88 88" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
            ...
            <div className={'flex flex-row flex-wrap  xl:flex-nowrap lg:gap-[26px] gap-[26px] w-full mt-[20px]'}>
                ...
                <div className={'w-full h-full  flex items-end  flex-col gap-[6px] h-[340px]'}>
                    ...
                    <div
                        className={'w-fit h-full pt-[10px]   md:pl-[30px] rounded-[32px] shadow1 bg-[#F4F4F4] pb-[40px] px-[25px] md:pr-[0px] flex flex-col md:flex-row'}>
