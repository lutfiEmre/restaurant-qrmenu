...
const PriceComponent = () => {
    ...
    return (
        <div className={'w-full flex justify-center items-center flex-wrap h-fit flex-row gap-[150px] md:gap-12 lg:gap-[150px] px-[37px]'}>
            <div
                className={'min-w-[340px] backdrop-blur-[25px] bgse max-h-[760px] h-full pb-[65px] bg-opacity-[35%] rounded-[20px] flex flex-col justify-start items-center pt-[36px] bg-[#F8F8F859]'}>
            ...
            <div
                className={'min-w-[340px] backdrop-blur-[25px] bgse max-h-[760px] h-full pb-[65px] bg-opacity-[35%] rounded-[20px] flex flex-col justify-start items-center pt-[36px] bg-[#FF7373]'}>
                <div className={'flex flex-col justify-center items-center'}>
